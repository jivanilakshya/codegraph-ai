import { ArrowDownLeft, ArrowUpRight, FileCode2, Network, X } from "lucide-react";
...
export function GraphInspector({ edges, node, nodesById, onClose, onNodeSelect, projectName }: GraphInspectorProps) {
